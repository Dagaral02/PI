...
<div id="general">
    <div id="cuerpo">
        <div id ="encabezado" class="col-md-12">
            <div class="col-md-8">
                <h1 class="titulo">Lista de tareas cliente</h1>
            </div>
            <div class="dropdown col-md-4">
                <button onclick="myFunction()" class="btn dropbtn" style="width: 100%;">Opciones</button>
                <div id="myDropdown" class="dropdown-content">
                    <a href="TareaCliente">Crear Tarea</a>
                    <a href="Modificarcliente">Modificar</a>
                </div>
            </div>
            <script>
        ...
        <div id="contenido" class="panel-scroll">
            ...
            $resultado = mysqli_query($conn, "SELECT CodigoTarea, Tarea, FechaInicio, FechaFin, Estado FROM Tareas where Departamento = 'Cliente'");
